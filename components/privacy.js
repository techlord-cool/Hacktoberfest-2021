...
const Privacy = () => {
  ...
  return (
    <div className="privacy">
      ...
      <p>
        One Shop Store built the One Shop Store app as a Free app. This SERVICE
        is provided by One Shop Store at no cost and is intended for use as is.
      </p>{" "}
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at One Shop Store unless
      ...
      <p>
        ...
        but not limited to Location. The information that we request will be
      ...
      <p>
        ...
        not hesitate to contact us at contact@oneshopstore.co.in.
      </p>
    </div>
  );
};
